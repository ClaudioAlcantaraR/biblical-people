<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-8">
        ...
        <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mt-6">¿No estas registrado?<a class="ml-1 text-blue-700 hover:underline dark:text-blue-500" href="/register/">Crear una cuenta</a></div>
    </form>
</x-guest-layout>
